etc -e "/e[34m install golang -y\e[0m"
yum install golang -y &>>/tmp/roboshop.log
etc -e "/e[34m add user\e[0m"
useradd roboshop &>>/tmp/roboshop.log
etc -e "/e[34m  create application drive\e[0m"
rm -rf /app &>>/tmp/roboshop.log
mkdir /app
etc -e "/e[34m download application content\e[0m"
curl -L -o /tmp/dispatch.zip https://roboshop-artifacts.s3.amazonaws.com/dispatch.zip &>>/tmp/roboshop.log
etc -e "/e[34m extract the application content\e[0m"
unzip /tmp/dispatch.zip &>>/tmp/roboshop.log
cd /app
etc -e "/e[34m download denpencies\e[0m"
...
etc -e "/e[34m start dispatch service \e[0m"
